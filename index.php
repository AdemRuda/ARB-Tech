...
<head>
  ...
  <title>ARB - Tech PC - Landing Page</title>
  <?php 
    require "header.php"; 
...
<body>
  <div class="slider" style="width: 60%; margin: auto;">
    <ul class="slides">
      ...
      <li>
        ...
        <div class="caption center-align">
          <h3 class="bold page-title">At ARB - Tech</h3>
  ...
  <div class="section" style="margin-top: 100px;">
    <div class="wide-container">
      ...
      <h5 class="white-text center">
        At <b class="orange-text">ARB - Tech PC</b>, We are a team of serious gamers and overclockers with a passion towards customized and fast PCs.
      </h5>
    </div>
  </div>
  ...
  <h3 class="white-text center">ARB - Tech PC - White PC Build</h3>
